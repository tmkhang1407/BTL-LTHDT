...
public class Snake {
    ...
    public void update(){
        ...
        for(int i=1; i<lenght-1; i++){
            ...
            &&arrPartSnake.get(i).getrBotom().intersect(arrPartSnake.get(i-1).getrBody())
        ...
        }else if(arrPartSnake.get(lenght-1).getrBotom().intersect(arrPartSnake.get(lenght-2).getrBody())){
    ...
    public Bitmap getGetBm_body_bottom_left() {
        return bm_body_bottom_left;
    }

    public void setGetBm_body_bottom_left(Bitmap getBm_body_bottom_left) {
        this.bm_body_bottom_left = getBm_body_bottom_left;
    }
    ...
    public Bitmap getGetBm_tail_left() {
        return bm_tail_left;
    }

    public void setGetBm_tail_left(Bitmap getBm_tail_left) {
        this.bm_tail_left = getBm_tail_left;
    }
    ...
    public Bitmap getGetBm_tail_down() {
        return bm_tail_down;
    }

    public void setGetBm_tail_down(Bitmap getBm_tail_down) {
        this.bm_tail_down = getBm_tail_down;
    }
